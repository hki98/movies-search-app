 ...
 * Spinner Component
 * 
 * Displays a loading spinner animation to indicate that content is being loaded.
 * Uses an SVG-based spinner with animation.
 * 
 ...
 * 
 * @returns {JSX.Element} Rendered Spinner component with SVG animation
 */
const Spinner = () => {
    return (
        <div role="status">
